...
Diese Allgemeinen Geschäftsbedingungen gelten für alle Bestellungen bei:
...
Diese AGB gelten ausschließlich gegenüber Verbrauchern im Sinne des § 13 BGB.

## 2. Bestellvorgang und Vertragsschluss

### 2.1 Online-Bestellsystem
Bestellungen können auf folgende Weise aufgegeben werden:
- Über unsere Website www.restaurant-campus.de
- Über WhatsApp Business: 0231 - 72 56 668
- Telefonisch: 0231 - 72 56 668
- Über Lieferando-Plattform

### 2.2 WhatsApp-Bestellungen
**Wichtiger Hinweis:** Bei Bestellungen über WhatsApp werden Ihre Daten über die WhatsApp Business API übertragen. Mit der Bestellung über WhatsApp stimmen Sie der Datenübertragung an WhatsApp (Meta Platforms Ireland Limited) zu.

**Bestellablauf über WhatsApp:**
1. Sie senden uns Ihre Bestellung über WhatsApp
2. Wir bestätigen Ihre Bestellung und den Gesamtpreis
3. Sie bestätigen die Bestellung
4. Wir beginnen mit der Zubereitung

### 2.3 Vertragsschluss
- Mit Ihrer Bestellung geben Sie ein verbindliches Angebot zum Abschluss eines Kaufvertrages ab
- Der Vertrag kommt mit unserer ausdrücklichen Annahme (Bestätigung) zustande
- Wir behalten uns vor, Bestellungen ohne Angabe von Gründen abzulehnen

### 2.4 Ablehnungsgründe
Wir können Bestellungen ablehnen bei:
- Unvollständigen oder falschen Angaben
- Lieferung außerhalb unseres Liefergebiets
- Nichtverfügbarkeit der bestellten Artikel
- Überschreitung unserer Kapazitäten
- Unterschreitung des Mindestbestellwerts
...
- EC-Kartenzahlung bei Lieferung oder Abholung
- Kontaktlose Zahlung (wo verfügbar)
...
- Bei hohem Bestellaufkommen können sich die Zeiten auf bis zu 60 Minuten verlängern
- Die angegebenen Zeiten sind Richtwerte und nicht verbindlich
- An Wochenenden und Feiertagen können längere Lieferzeiten auftreten

### 4.3 Abholung
- Abholung ist täglich von 11:00 - 21:30 Uhr möglich
- Bitte warten Sie auf die Bestätigung, dass Ihre Bestellung zur Abholung bereit ist

## 5. Widerrufsrecht und Stornierung

### 5.1 Ausschluss des Widerrufsrechts
Das Widerrufsrecht ist gemäß § 312g Abs. 2 Nr. 1 und 2 BGB ausgeschlossen für:
- Lieferung von Waren, die schnell verderben können oder deren Verfallsdatum schnell überschritten würde
- Lieferung von Waren, die nach Kundenspezifikation angefertigt wurden (individuelle Pizzen/Gerichte)

### 5.2 Stornierung vor Zubereitung
- Eine Stornierung der Bestellung ist nur vor Beginn der Zubereitung möglich
- Nach Bestätigung der Bestellung beginnen wir umgehend mit der Zubereitung
- Stornierungen sind telefonisch oder über WhatsApp möglich

## 6. Gewährleistung und Reklamationen

### 6.1 Mängel
- Beanstandungen sind unverzüglich, spätestens bei Lieferung/Abholung mitzuteilen
- Bei berechtigten Beanstandungen bieten wir Ihnen wahlweise:
  - Nachlieferung
  - Erstattung des Kaufpreises
  - Nachbesserung

### 6.2 Reklamationsfrist
Reklamationen sind innerhalb von 30 Minuten nach Erhalt der Ware mitzuteilen.

## 7. Haftung

### 7.1 Haftungsausschluss
- Eine Haftung für leichte Fahrlässigkeit ist ausgeschlossen, soweit nicht Schäden aus der Verletzung des Lebens, des Körpers oder der Gesundheit oder Schäden aus der Verletzung einer wesentlichen Vertragspflicht betroffen sind
- Bei Verletzung wesentlicher Vertragspflichten ist die Haftung auf den vertragstypischen, vorhersehbaren Schaden begrenzt

### 7.2 Allergene und Unverträglichkeiten
- Informationen zu Allergenen finden Sie in unserer Speisekarte
- Bei Allergien oder Unverträglichkeiten informieren Sie uns bitte bei der Bestellung
- Eine Gewähr für die vollständige Allergenfreiheit können wir nicht übernehmen

## 8. Datenschutz und WhatsApp-Nutzung
...
- Bei Nutzung von WhatsApp für Bestellungen werden Ihre Daten über die WhatsApp Business API verarbeitet
- WhatsApp wird von Meta Platforms Ireland Limited betrieben
